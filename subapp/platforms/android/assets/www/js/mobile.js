/*! jQuery Mobile 1.3.2 | Git HEAD hash: 528cf0e <> 2013-07-19T22:17:57Z | (c) 2010, 2013 jQuery Foundation, Inc. | jquery.org/license */ ! function(a, b, c) {
    ...
    function(a, d) {
        ...
        A = function() {
            ...
            if (n.isEmbeddedPage(l)) return e.reject(k, c), e.promise();
            if (g.length) {
        ...
        a.widget("mobile.slider", a.mobile.widget, a.extend({
            ...
            _create: function() {
                var e, f, g = this,
                    ...
                    z = a(y),
                    A = this.options.highlight && !this.isToggleSwitch ? function() {
            ...
            refresh: function(b, d, e) {
                ...
                } else null == b && (b = q ? parseFloat(p.val() || 0) : p[0].selectedIndex), o = 100 * ((parseFloat(b) - s) / (t - s)); if (!isNaN(o)) {
                    var v = o / 100 * (t - s) + s,
                        w = (v - s) % u,
                        x = v - w;
