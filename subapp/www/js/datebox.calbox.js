    ...
    $.extend($.mobile.datebox.prototype._build, {
        'calbox': function() {
            ...
            if (o.calUsePickers === true) {
                ...
                cal.picker.find('select').selectmenu({
                    mini: true,
                    nativeMenu: true
                });
            ...
            for (var row = 0, rows = cal.gen.length; row < rows; row++) {
                ...
                if (o.calShowWeek) {
                    ...
                    }).text('W' + cal.wk).appendTo(hRow);
                    cal.wk++;
                    if (cal.wk > 52 && typeof cal.gen[parseInt(row, 10) + 1] !== 'undefined') {
                        cal.wk = new Date(cal.theDateArr[0], cal.theDateArr[1], ((w.__('calStartDay') === 0) ? cal.gen[parseInt(row, 10) + 1][1][0] : cal.gen[parseInt(row, 10) + 1][0][0])).getWeek(4);
                    }
                }
