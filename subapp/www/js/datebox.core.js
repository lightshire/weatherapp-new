    ...
    $.widget("mobile.datebox", $.mobile.widget, {
        ...
        _enhanceDate: function() {
            $.extend(this._date.prototype, {
                copy: function(adjust, override) {
                    ...
                    return new Date(
                        ((override[0] > 0) ? override[0] : this.getFullYear() + adjust[0]), ((override[1] > 0) ? override[1] : this.getMonth() + adjust[1]), ((override[2] > 0) ? override[2] : this.getDate() + adjust[2]), ((override[3] > 0) ? override[3] : this.getHours() + adjust[3]), ((override[4] > 0) ? override[4] : this.getMinutes() + adjust[4]), ((override[5] > 0) ? override[5] : this.getSeconds() + adjust[5]), ((override[6] > 0) ? override[5] : this.getMilliseconds() + adjust[6]));
                },
        ...
        _makeDate: function(str) {
            ...
            if (exp_input === null || exp_input.length !== exp_format.length) {
                ...
                if (d.yday !== false) {
                    date.set(1, 0).set(2, 1).adj(2, (d.yday - 1));
                }
                if (d.wday !== false) {
        ...
        _create: function() {
            ...
            var w = this,
                ...
                thisTheme = (o.theme === false && typeof($(this).jqmData('theme')) === 'undefined') ?
                    ...
                    o.themeDefault : this.element.parentsUntil(':jqmData(theme)').parent().jqmData('theme')) : o.theme,
